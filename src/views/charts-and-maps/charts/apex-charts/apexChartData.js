...
<script>
  ...
  clientTrendsChart: {
    series: [{
      name: 'New Client Joining',
      data: [44, 55, 57, 56, 61, 58, 63, 60, 66]
    }, {
      name: 'New Orders Created',
      data: [76, 85, 101, 98, 87, 105, 91, 114, 94]
    }],
    chartOptions: {
      colors: themeColors,
...
<script>
  ...
  pieChart: {
    ...
    chartOptions: {
      ...
      colors: ['#8e44ad', '#28C76F', '#EA5455', '#7367F0'],
      fill: {
        type: 'gradient',
        gradient: {
          shade: 'dark',
          type: 'horizontal',
          shadeIntensity: 0.5,
          gradientToColors: ['#8e44ad', '#28C76F', '#EA5455', '#7367F0']
        }
      },
      dataLabels: {
        enabled: false
  ...
  clientDetailsChart: {
    series: [50, 180, 5, 8, 180],
    chartOptions: {
      labels: ['New', 'Active', 'Pending', 'Inactive', 'totalClients'],
      dataLabels: {
        enabled: false
      },
      responsive: [{
    ...
    chartOptions: {
      ...
      fill: {
        ...
        gradient: {
          ...
          type: 'horizontal',
          shadeIntensity: 0.5,
          gradientToColors: ['#8e44ad', '#28C76F', '#EA5455']
        }
      },

      labels: ['TotalSTBs', 'AssignedSTBs', 'ActiveSTBs'],
      responsive: [{
        breakpoint: 480,
        options: {
          chart: {
