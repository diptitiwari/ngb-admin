  ...
  <div class="the-navbar__user-meta flex items-center" v-if="activeUserInfo.username">
    ...
    <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
      <div class="con-img ml-3">
        ...
        <vs-avatar :text="getUserFullName" width="40" height="40" class="rounded-full shadow-md cursor-pointer block"/>
      </div>
        ...
        <ul style="min-width: 9rem">
          ...
          <li class="flex py-2 px-4 cursor-pointer hover:bg-primary hover:text-white">
           <feather-icon icon="UserIcon" svgClasses="w-4 h-4" />
            <span class="ml-2">{{$t('label.anchor.profile')}}</span>
          </li>
          </router-link>
          <router-link to='/shortcut'> 
          <li class="flex py-2 px-4 cursor-pointer hover:bg-primary hover:text-white">
           <feather-icon icon="ExternalLinkIcon" svgClasses="w-4 h-4" />
            <span class="ml-2">{{$t('label.anchor.shortcut')}}</span>
          </li>
          </router-link>
          <!-- <li class="flex py-2 px-4 cursor-pointer hover:bg-primary hover:text-white">
          ...
          <li
            ...
            <span class="ml-2">{{$t("label.heading.logout")}}</span>
          </li>
        </ul>
      </vs-dropdown-menu>
    </vs-dropdown>
