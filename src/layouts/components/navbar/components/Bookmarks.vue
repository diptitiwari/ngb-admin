  ...
  <div class="navbar-bookmarks flex items-center">
    ...
    <ul class="vx-navbar__starred-pages">
      <!-- <draggable v-model="starredPagesLimited" :group="{name: 'pinList'}" class="flex cursor-move">
        <li class="starred-page" v-for="page in horizonalMenu" :key="page.url">
    ...
    <!-- STARRED PAGES MORE -->
    <!-- <div class="vx-navbar__starred-pages--more-dropdown">
      <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
        <vx-tooltip text="Reports" position="bottom" delay=".3s">
          <feather-icon icon="BookOpenIcon" svgClasses="h-6 w-6" class="cursor-pointer p-2"></feather-icon>
    ...
    <div class="vx-navbar__starred-pages--more-dropdown">
      <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
        <vx-tooltip text="Admin" position="bottom" delay=".3s">
          <feather-icon icon="UserPlusIcon" svgClasses="h-6 w-6" class="cursor-pointer p-2"></feather-icon>
          <feather-icon icon="ChevronDownIcon" svgClasses="h-4 w-4" class="cursor-pointer p-2"></feather-icon>
        </vx-tooltip>
        <vs-dropdown-menu>
          <ul class="vx-navbar__starred-pages-more--list">
  ...
  data() {
    return {
      ...
      adminDropdown: [
        ...
        {
          title: "Provisioning Orders",
          url: "/provisioning_orders"
        },
        {
          title: "Hooks(EventActions)",
          url: "/hooks"
        }
      ]
    };
